...
{
    "location": "index.html#AbstractFFTs.jl-1",
    "page": "Home",
...
{
    "location": "api.html#AbstractFFTs.fft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.ifft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.bfft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.plan_fft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.plan_ifft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.plan_bfft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.rfft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.irfft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.brfft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.plan_rfft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.plan_brfft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.plan_irfft",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.fftshift-Tuple{Any}",
    "page": "API",
...
{
    "location": "api.html#AbstractFFTs.fftshift-Tuple{Any,Any}",
    "page": "API",
    "title": "AbstractFFTs.fftshift",
    "category": "Method",
...
{
    "location": "api.html#AbstractFFTs.ifftshift",
    "page": "API",
...
{
    "location": "api.html#Public-Interface-1",
    "page": "API",
...
{
    "location": "implementations.html#FFT-Implementations-1",
    "page": "Implementations",
...
{
    "location": "implementations.html#Existing-packages-1",
    "page": "Implementations",
...
{
    "location": "implementations.html#Defining-a-new-implementation-1",
    "page": "Implementations",
    "title": "Defining a new implementation",
    "category": "section",
    "text": "Implementations should implement Base.A_mul_B!(Y, plan, X) so as to support pre-allocated output arrays. We don't define * in terms of A_mul_B! generically here, however, because of subtleties for in-place and real FFT plans.To support inv, \\, and A_ldiv_B!(y, plan, x), we require Plan subtypes to have a pinv::Plan field, which caches the inverse plan, and which should be initially undefined. They should also implement plan_inv(p) to construct the inverse of a plan p.Implementations only need to provide the unnormalized backwards FFT, similar to FFTW, and we do the scaling generically to get the inverse FFT."
},
